...
/** Small GitHub link pinned to the card's corner — a separate click target that
 *  still opens the repo externally (kept out of the card-body <Link>). */
function GitHubCorner({ repo, name }: { repo: string; name: string }) {
  return (
    <a
      ...
      className="absolute right-3 top-3 z-20 flex h-8 w-8 items-center justify-center rounded-lg bg-black/50 text-zinc-300 ring-1 ring-white/10 backdrop-blur transition-colors hover:text-white hover:ring-white/30"
    >
