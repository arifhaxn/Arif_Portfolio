...
// `icon` is a single 24×24 brand glyph path (fill=currentColor → monochrome).
export const SOCIALS: { label: string; href: string; icon: string }[] = [
  {
    label: "GitHub",
    href: "https://github.com/arifhaxn",
  ...
  {
    label: "Facebook",
    href: "https://facebook.com/arifhaxnn",
